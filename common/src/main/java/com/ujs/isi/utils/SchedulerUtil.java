...
public class SchedulerUtil {
    ...
    private static Logger log = LoggerFactory.getLogger(SchedulerUtil.class);// log4j记录日志
     ...
     * @date 2018-6-25 <br>
     */
    public static Scheduler hadleCronTrigger(String jobName, String jobGroupName,
